...
// -----------------------------------------------------------------------------
/// @brief da valor a los uniforms relacionados con las fuentes de luz
/// @param color       vector de colores RGB de las fuentes de luz
/// @param pos_dir_wc  vector de posiciones y/o direcciones de las fuentes
///
...
// -----------------------------------------------------------------------------
/// @brief Guarda una copia de la matriz de modelado actual en el tope de la pila.
///
void Cauce::pushMM()
{
...
// -----------------------------------------------------------------------------
/// @brief Restaura la última matriz de modelado guardada con 'popMM', y 
/// elimina el tope de la pila de matrices de modelado
///
void Cauce::popMM()
{
   CError();
...
{
   return "Cauce programable, OpenGL 3.3+ core." ;
}
