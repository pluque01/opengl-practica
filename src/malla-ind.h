...
protected:
  ...
  // necesarios para una malla indexada (y que no aparezcan ya declarados en
  // esta plantilla)
  // ......
  ...
  // descriptor del VAO con los vértices, triángulos y atributos de esta malla
  // indexada (se crea bajo demanda en 'visualizarGL')
...
public:
  Tetraedro(const glm::vec3 &p_nuevo_color = glm::vec3(0.0, 1.0, 1.0));
};
// ---------------------------------------------------------------------
